...
public class Board {
    ...
    public Board (){
        ...
        Property go = new Property("Go", 0, false, 0, true, "", false, 0);
        ...
        Property  incTax = new Property("Income Tax", 0, false,3, true, "", false, 0);
        propertyholder.put(3,incTax);
        Property  rr1 = new Property("Reading Railroad", 200, false,4, true, "", true, 0);
        ...
        Property jail = new Property("Jail", 0, false, 8,true, "", false, 0);
        propertyholder.put(8,jail);
        Property p10 = new Property("St. Charles Place", 140, false,9,false, "", false, 3);
        propertyholder.put(9,p10);
        Property eleccompany = new Property("Electric Company", 150, false,10,true, "", true, 0);
        ...
        Property  p14 = new Property("Pennsylvania Railroad", 200, false,13, true, "", true, 0);
        ...
        Property fpark = new Property("Free Parking", 0, false,17, true, "", false, 0);
        ...
        Property p22 = new Property("B&O Railroad", 200, false,21, true, "", true, 0);
        ...
        Property waterworks = new Property("Water Works", 150, false,24, true, "", true, 0);
        ...
        Property goToJail = new Property("Go To Jail", 100, false,26, true, "", false, 0);
        ...
        Property  p31 = new Property("Short Line Railroad", 200, false,30, true, "", true, 0);
        propertyholder.put(30,p31);
        Property p32 = new Property("Park Place", 350, false,31, false, "", false, 8);
        propertyholder.put(31,p32);
        Property  p33 = new Property("Luxury Tax", 0, false,32, true, "", false, 0);
